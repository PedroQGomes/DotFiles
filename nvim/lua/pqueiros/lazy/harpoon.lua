return {
    ...
    keys = {
      { "<F8>", function() require("harpoon"):list():add() end, desc = "Add Harpoon file", },
      { "<F7>", function() local harpoon = require("harpoon") harpoon.ui:toggle_quick_menu(harpoon:list()) end, desc = "Harpoon quick menu", },
      ...
      { "<F6>", function() require("harpoon"):list():select(6) end, desc = "Harpoon to file 6", },
    },
}